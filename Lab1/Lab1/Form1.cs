namespace Lab1
{
    public partial class Form1 : Form
    {
        ...
        private void ñîõğàíèòüToolStripMenuItem_Click(object sender, EventArgs e)
        {
            if (image == null)
            {
                MessageBox.Show("Èçîáğàæåíèå íå íàéäåíî.", "Îøèáêà", MessageBoxButtons.OK, MessageBoxIcon.Error);
                return;
            }
            ...
            if (saveDialog.ShowDialog() == DialogResult.OK)
            {
                try
                {
                    ...
                    MessageBox.Show("Èçîáğàæåíèå ñîõğàíåíî.", "Ñîõğàíåíèå", MessageBoxButtons.OK, MessageBoxIcon.Information);
                }
                catch (Exception ex)
                {
                    MessageBox.Show($"Îøèáêà ïğè ñîõğàíåíèè èçîáğàæåíèÿ: {ex.Message}", "Îøèáêà", MessageBoxButtons.OK, MessageBoxIcon.Error);
                }
            }
        }
